...
// TODO: rename to BlockBodyIndexerHandler
type BlockIndexerHandler interface {
	ResourceAwareIndexHandler
	HandleMatch(body *types.Body)
}

// TODO: extract common logic from runIncrementalLogIndexerExecutor
func runIncrementalBlockIndexerExecutor(db kv.RoDB, tx kv.RwTx, blockReader services.FullBlockReader, startBlock, endBlock uint64, isShortInterval bool, logEvery *time.Ticker, ctx context.Context, s *StageState, handler BlockIndexerHandler) (uint64, error) {
